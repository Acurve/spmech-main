...
import { IconBrandFacebook, IconBrandInstagram, IconBrandLinkedin, IconBrandYoutube, IconHeartFilled, IconLocation, IconMail, IconPhone } from '@tabler/icons-react'
    ...
    <div className='flex flex-col lg:flex-row gap-10 lg:gap-0'>
      <div className='lg:w-[50%]'>
        <div className='flex gap-8'>
          <a href="" target='_blank'><IconBrandFacebook /></a>
          <a href="" target='_blank'><IconBrandInstagram /></a>
          <a href="" target='_blank'><IconBrandYoutube /></a>
          <a href="" target='_blank'><IconBrandLinkedin /></a>
  ...
  return (
    <div>
      <div className='flex justify-center space-x-2'>
        ...
        <LinkTag className='text-black! font-medium after:bg-destructive'>
